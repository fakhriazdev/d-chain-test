            ...
            <div className="relative overflow-x-auto shadow-md sm:rounded-lg ">
                <form className="p-6" onSubmit={formik.handleSubmit} encType='multipart/form-data'>
                                ...
                                <div className="text-center">
                                    ...
                                    <div className="mt-4 flex text-gray-600">
                                        <label htmlFor="documents"
                                            ...
                                            <input id="documents" name="documents" type="file" className="sr-only" onInput={handleFormInput}/>
                                        </label>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className="mt-6 flex items-center justify-end gap-x-6">
                        <button type="submit" className="text-sm py-3 lg:py-3 rounded-md font-normal bg-orange leading-6 text-white w-full border-2 border-white hover:text-orange hover:bg-white hover:border-orange">
                            <FileDownloadOutlinedIcon/> Add Company
                        </button>
