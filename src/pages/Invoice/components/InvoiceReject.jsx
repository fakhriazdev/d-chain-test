        ...
        <div className=" w-full rounded-2xl shadow-md min-h-fit p-10">
          ...
          <div className="flex flex-col gap-3">
            ...
            <div class="relative overflow-x-auto">
              ...
              <div className="w-full h-10 bg-red bg-opacity-20 rounded-2xl flex my-auto mx-auto">
              ...
              <div className="flex w-full">
                <div className="w-1/2">
                  <h4 className="text-[18px] mt-5 mb-3">Quality Issues</h4>
                  <p className="">Jumlah barang kurang</p>
