          ...
          <form className="w-full p-10">
            ...
            <div className="flex flex-wrap -mx-3 mb-2">
              <div className="w-full md:w-1/2 px-3 mb-2 md:mb-0">
                <label className="block tracking-wide mb-2" htmlFor="province">
                  Province
                </label>
              ...
              <div className="w-full md:w-1/2 px-3">
                <label className="block tracking-wide mb-2" htmlFor="city">
                  City
                </label>
                <div className="relative">
                  <select
            ...
            <div className="flex flex-wrap -mx-3 mb-2">
              <div className="w-full px-3">
                <label className="block tracking-wide mb-2" htmlFor="address">
                  Address
                </label>
                <input
                  className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:ring-orange focus:border-orange"
            ...
            <label
              className="block tracking-wide mb-1 mt-5"
              htmlFor="companyEmail"
            >
              User Account
            </label>
            <div className="flex flex-wrap -mx-3 mb-2">
              <div className="w-full md:w-1/2 px-3 mb-2 md:mb-0">
                <label
                  className="block tracking-wide text-lable text-gray mb-2"
                  htmlFor="companyEmail"
                >
                  Username
                </label>
